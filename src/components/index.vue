<template>
	<div class="index">
		<div style="text-align: center;">
			...
			<el-button @click="toThree" type="success" style="width: 200px; display: block;margin: 30px auto;">动力冷却性能数据查询体统</el-button>
			<el-button @click="toFour" type="success" style="width: 200px; display: block;margin: 30px auto;">人体接触温度评估系统</el-button>
